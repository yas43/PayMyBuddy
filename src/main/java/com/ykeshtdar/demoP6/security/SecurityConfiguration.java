    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
      return   httpSecurity
                ...
                .authorizeHttpRequests(
                        registry->{
                                   registry.requestMatchers("/user/welcome","/registry/user","registry/{userId}/friend/{friendId}","registry/{senderId}/receiver/{receiverId}","registry/{senderId}/alltransaction/{receiverId}").permitAll();
